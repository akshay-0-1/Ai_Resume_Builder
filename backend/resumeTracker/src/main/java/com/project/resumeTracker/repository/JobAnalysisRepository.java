...
public interface JobAnalysisRepository extends JpaRepository<JobAnalysis, UUID> {
     ...
     */
    List<JobAnalysis> findTop5ByUserIdAndIsActiveTrueOrderByCreatedAtDesc(Long userId);
    ...
    List<JobAnalysisHistoryDTO> findJobAnalysisHistoryByUserId(Long userId, Pageable pageable);
     ...
     */
    List<JobAnalysis> findByUserIdAndIsActiveTrueOrderByCreatedAtAsc(Long userId);
}
